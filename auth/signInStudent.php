...
<body>
    ...
    <div class="grid min-h-screen place-items-center">
        <div class="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
            ...
            <br><br>
            <form class="submit-signin-student mt-6" action="../backend/signin.bkd.php" method="POST">
                ...
                <button type="submit" name="submit-signin-student" class="w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none">
                    Sign In
                </button>
