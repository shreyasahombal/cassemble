    ...
    ?>
        <div class="grid min-h-screen place-items-center">
            <div class="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
                <h1 class="text-l text-center font-light">cassemble.college</h1>
                <br><br>
                <h1 class="text-center text-9xl font-black">Sign Up</h1>
                <br><br>
                <form class="submit-signup-college mt-6" action="../backend/signup.bkd.php" method="POST">
                    <label for="emailID" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">E-mail</label>
                    <input id="emailID" type="email" name="emailID" placeholder="some-college@some-domain.edu.in" autocomplete="email" class="text-center block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
                    ...
                    <button type="submit" name="submit-signup-college" class="w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none">
                        Register College
                    </button>
